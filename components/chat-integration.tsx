    ...
    try {
      ...
      client.on("message", (channel, tags, message, self) => {
        ...
        // COMMUNITY GARDEN COMMANDS - Changed !garden to !startgarden
          ...
          addRecentCommand(`${command} by ${username}`)
        } else if (command === "!scoreboard" || command === "!leaderboard") {
          console.log("Trivia leaderboard command detected")
          window.dispatchEvent(new CustomEvent("requestTriviaLeaderboard", { detail: { username } }))
          addRecentCommand(`${command} by ${username}`)
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <span className="ml-2 text-black bg-pink-200 px-1 rounded">Trigger flower celebration (mods only)</span>
                    ...
                    {/* Added command for trivia leaderboard */}
                    <div>
                      <code className="bg-black text-pink-400 px-2 py-1 rounded">!leaderboard</code>
                      <span className="ml-2 text-black bg-pink-200 px-1 rounded">Flip timer to show trivia leaders</span>
                    </div>
